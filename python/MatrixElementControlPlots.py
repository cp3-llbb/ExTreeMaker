    ...
    def process(self, event):
        ...
        if not leptons is None:
            ...
            if not dijet[0] is None:
                b1 = ROOT.TLorentzVector(dijet[0].px(), dijet[0].py(), dijet[0].pz(),
                                         dijet[0].energy())  # self._JECuncertainty.jet(dijet[0])
                jetPt = b1.Pt()
            ...
            if not dijet[1] is None:
                b2 = ROOT.TLorentzVector(dijet[1].px(), dijet[1].py(), dijet[1].pz(),
                                         dijet[1].energy())  # self._JECuncertainty.jet(dijet[1])
                jetPt = b2.Pt()
