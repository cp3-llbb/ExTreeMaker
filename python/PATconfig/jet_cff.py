...
def setupPatJets(process, runOnMC):
    ...
    if runOnMC:
        ...
        process.preJetSequence = cms.Sequence(
            process.genParticlesForJets * process.genParticlesForJetsNoNu * process.ak5GenJetsNoNu)
    else:
        process.preJetSequence = cms.Sequence()
    # jets
    ...
    process.selectedPatJetsWithBeta = cms.EDProducer('JetBetaProducer',
                                                     ...
                                                     puJetIdMVA=cms.InputTag("pileupJetIdProducerChs",
                                                                             "fullDiscriminant"),
    ...
    process.patDefaultSequence.replace(process.selectedPatJets, cms.Sequence(
        process.selectedPatJets * process.pileupJetIdProducerChs * process.selectedPatJetsWithBeta))
