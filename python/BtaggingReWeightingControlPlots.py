...
class BtaggingReWeightingControlPlots(BaseControlPlots):
    ...
    def beginJob(self, btagging="CSV", WP=["M", "L"]):
        ...
        for cat in EventSelection.categoryNames:
            wpcat = "CA8" * cat.count("CA8") + "Subjets" * cat.count("Subjets") + "subjets" * cat.count("subjets") + WP[
                                                                                                                         1] * cat.count(
                "HE") + WP[0] * cat.count("HP")
            if wpcat == "": continue
        ...
        self.add(self.WP[1] + self.WP[1] + self.WP[1] + "excl", self.WP[1] + self.WP[1] + self.WP[1] + "excl", 200, 0,
                 2)
        self.add(self.WP[0] + self.WP[0] + self.WP[0] + "excl", self.WP[0] + self.WP[0] + self.WP[0] + "excl", 200, 0,
                 2)
    ...
    def process(self, event):
        ...
        result[self.WP[1] + "excl"] = event.weight(weightList=["Btagging"], forceMode=self.WP[1] + "excl",
                                                   btagging=self._btagging)
        result[self.WP[0] + "excl"] = event.weight(weightList=["Btagging"], forceMode=self.WP[0] + "excl",
                                                   btagging=self._btagging)
        result[self.WP[1] + self.WP[1]] = event.weight(weightList=["Btagging"], forceMode=self.WP[1] + self.WP[1],
                                                       btagging=self._btagging)
        result[self.WP[1] + self.WP[0]] = event.weight(weightList=["Btagging"], forceMode=self.WP[1] + self.WP[0],
                                                       btagging=self._btagging)
        result[self.WP[0] + self.WP[0]] = event.weight(weightList=["Btagging"], forceMode=self.WP[0] + self.WP[0],
                                                       btagging=self._btagging)

        result[self.WP[1] + self.WP[1] + "excl"] = event.weight(weightList=["Btagging"],
                                                                forceMode=self.WP[1] + self.WP[1] + "excl",
                                                                btagging=self._btagging)
        result[self.WP[0] + self.WP[0] + "excl"] = event.weight(weightList=["Btagging"],
                                                                forceMode=self.WP[0] + self.WP[0] + "excl",
                                                                btagging=self._btagging)
        result[self.WP[1] + self.WP[1] + self.WP[1]] = event.weight(weightList=["Btagging"],
                                                                    forceMode=self.WP[1] + self.WP[1] + self.WP[1],
                                                                    btagging=self._btagging)
        result[self.WP[0] + self.WP[0] + self.WP[0]] = event.weight(weightList=["Btagging"],
                                                                    forceMode=self.WP[0] + self.WP[0] + self.WP[0],
                                                                    btagging=self._btagging)
        result[self.WP[1] + self.WP[1] + self.WP[1] + "excl"] = event.weight(weightList=["Btagging"],
                                                                             forceMode=self.WP[1] + self.WP[1] +
                                                                                       self.WP[1] + "excl",
                                                                             btagging=self._btagging)
        result[self.WP[0] + self.WP[0] + self.WP[0] + "excl"] = event.weight(weightList=["Btagging"],
                                                                             forceMode=self.WP[0] + self.WP[0] +
                                                                                       self.WP[0] + "excl",
                                                                             btagging=self._btagging)
        result["0" + self.WP[1] + "excl"] = event.weight(weightList=["Btagging"], forceMode="0" + self.WP[1] + "excl",
                                                         btagging=self._btagging)
        result["0" + self.WP[0] + "excl"] = event.weight(weightList=["Btagging"], forceMode="0" + self.WP[0] + "excl",
                                                         btagging=self._btagging)
