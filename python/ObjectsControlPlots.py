...
class JetmetControlPlots(BaseControlPlots):
    ...
    def beginJob(self, btagging="CSV", WP=["M", "L"], prejets=""):
        ...
        for imass in range(len(self.masspoints)):
            self.add("fsrjetpt_" + str(self.masspoints[imass]),
                     "fsr jet Pt for mH=" + str(self.masspoints[imass]) + "GeV", 1000, 0, 1000)
            self.add("fsrjetetapm_" + str(self.masspoints[imass]),
                     "fsr jet Eta for mH=" + str(self.masspoints[imass]) + "GeV", 50, -2.5, 2.5)
            self.add("fsrjetphi_" + str(self.masspoints[imass]),
                     "fsr jet Phi for mH=" + str(self.masspoints[imass]) + "GeV", 25, -4, 4)
            self.add("fsrjetmass_" + str(self.masspoints[imass]),
                     "fsr jet mass for mH=" + str(self.masspoints[imass]) + "GeV", 1000, 0, 3000.)
            self.add("trijetM_" + str(self.masspoints[imass]),
                     "invariant mass of b+bbar+fsrjet (mH=" + str(self.masspoints[imass]) + "GeV)", 1000, 0, 1000)
    ...
    def process(self, event):
        ...
        for index, jet in enumerate(getattr(event, self.prejets + "jets")):
            ...
            if goodJets[index]:
                ...
                if jetId(jet, "tight"):
                    result["jetsjetid"].append(3)
                elif jetId(jet, "medium"):
                    result["jetsjetid"].append(2)
                elif jetId(jet, "loose"):
                    result["jetsjetid"].append(1)
                else:
                    result["jetsjetid"].append(0)
                ...
                if jet.isPFJet():
                    ...
                    # result["jetsPtD"].append(jetPtD(jet)) #fixme: crashing with miniAOD
                # result["jetsVtx3dL"].append(jetVtx3dL(jet)) #fixme: crashing with miniAOD
                # result["jetsVtx3deL"].append(jetVtx3deL(jet)) #fixme: crashing with miniAOD
                # result["jetsVtxPt"].append(jetVtxPt(jet)) #fixme: crashing with miniAOD
                ...
                if nj < self.njets + 1:
                    ...
                    if jet.isPFJet():
                        ...
                        # result["jet" + str(nj) + "PtD"] = jetPtD(jet)#fixme: crashing with miniAOD
                    # result["jet" + str(nj) + "Vtx3dL"] = jetVtx3dL(jet)#fixme: crashing with miniAOD
                    # result["jet" + str(nj) + "Vtx3deL"] = jetVtx3deL(jet)#fixme: crashing with miniAOD
                    # result["jet" + str(nj) + "VtxPt"] = jetVtxPt(jet)#fixme: crashing with miniAOD
                ...
                if isBJet(jet, self.WP[1], self.btagging):
                    ...
                    if jet in dijet:
                        ...
                        if jetId(jet, "tight"):
                            result["bjet" + str(indexDijet) + "jetid"] = 3
                        elif jetId(jet, "medium"):
                            result["bjet" + str(indexDijet) + "jetid"] = 2
                        elif jetId(jet, "loose"):
                            result["bjet" + str(indexDijet) + "jetid"] = 1
                        else:
                            result["bjet" + str(indexDijet) + "jetid"] = 0
                        if jet.isPFJet():
                            ...
                            # result["bjet" + str(indexDijet) + "PtD"] = jetPtD(jet)#fixme: crashing with miniAOD
                        # result["bjet" + str(indexDijet) + "Vtx3dL"] = jetVtx3dL(jet)#fixme: crashing with miniAOD
                        # result["bjet" + str(indexDijet) + "Vtx3deL"] = jetVtx3deL(jet)#fixme: crashing with miniAOD
                        # result["bjet" + str(indexDijet) + "VtxPt"] = jetVtxPt(jet)#fixme: crashing with miniAOD
                        result["bjet" + str(indexDijet) + "SSVHEdisc"] = jet.bDiscriminator(
                            "simpleSecondaryVertexHighEffBJetTags")
                        result["bjet" + str(indexDijet) + "SSVHPdisc"] = jet.bDiscriminator(
                        ...
                        result["bjet" + str(indexDijet) + "CSVdisc"] = jet.bDiscriminator(
                        ...
                        ind += 1
                        if ind > self.nbjets:
                            print "Error: more than 4 b jets in the event!!"
                        else:
                            ...
                            if jetId(jet, "tight"):
                                result["bjet" + str(ind) + "jetid"] = 3
                            elif jetId(jet, "medium"):
                                result["bjet" + str(ind) + "jetid"] = 2
                            elif jetId(jet, "loose"):
                                result["bjet" + str(ind) + "jetid"] = 1
                            else:
                                result["bjet" + str(ind) + "jetid"] = 0
                            if jet.isPFJet():
                                ...
                                # result["bjet" + str(ind) + "PtD"] = jetPtD(jet)#fixme: crashing with miniAOD
                            # result["bjet" + str(ind) + "Vtx3dL"] = jetVtx3dL(jet)#fixme: crashing with miniAOD
                            # result["bjet" + str(ind) + "Vtx3deL"] = jetVtx3deL(jet)#fixme: crashing with miniAOD
                            # result["bjet" + str(ind) + "VtxPt"] = jetVtxPt(jet)#fixme: crashing with miniAOD
                            result["bjet" + str(ind) + "SSVHEdisc"] = jet.bDiscriminator(
                                "simpleSecondaryVertexHighEffBJetTags")
                            result["bjet" + str(ind) + "SSVHPdisc"] = jet.bDiscriminator(
                                "simpleSecondaryVertexHighPurBJetTags")
                            ...
                            result["bjet" + str(ind) + "CSVdisc"] = jet.bDiscriminator(
                                "combinedSecondaryVertexBJetTags")
        ...
        # result["METNNregression"] = event.METNNregression[0].pt()#fixme: crashing with miniAOD
        # result["METphiNNregression"] = event.METNNregression[0].phi()#fixme: crashing with miniAOD
        ...
        # rho
        # result["rho"] = event.rho[0]#fixme: crashing with miniAOD
